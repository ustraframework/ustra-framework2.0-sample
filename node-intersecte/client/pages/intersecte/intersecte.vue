<template>
  <div v-scroll.bottom="{ handler: onScrollDown, options: { duration: 1000 } }">
    ...
    <!-- <IntersectLazyProduct v-for="item in products" :key="item.code" :product="item" /> -->
  </div>
</template>
<script lang="ts">
...
const products = [
  {
    code: 1,
    name: '상품1',
    imgPath: 'https://s.pstatic.net/shopping.phinf/20220518_3/ec962f8b-acb9-4c43-811e-e8f21bbd2679.jpg?type=f214_292',
  },
  {
    code: 2,
    name: '상품2',
