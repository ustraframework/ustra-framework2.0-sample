<template>
  <div>
    <div>파일 업로드 테스트 페이지 (S3)</div>
    <u-file-upload-box
      ref="fileUploadBox"
      v-model="fileInfo"
      file-grp-id="test-s3-upload"
      upload-type="multi"
      :deletable="true"
      :editable="true"
      :downable="true"
    ></u-file-upload-box>
    <dx-button text="Upload" @click="$refs.fileUploadBox.upload()"></dx-button>
  </div>
</template>
<script lang="ts">
...
export default class extends UstraBoComponent {
  ...
  @Ref() readonly fileUploadBox: UFileUploadBox
  // #endregion
  // #region hooks
  // #endregion
  // #region methods
